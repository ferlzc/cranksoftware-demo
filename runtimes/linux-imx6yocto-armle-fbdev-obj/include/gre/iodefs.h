 ...
 *
 * TODO: Read this from an event definition file
 * TODO: Support hashing the name for fast compare
 * TODO: Support data structure signatures
 */
...
/**
 * Event that is emitted when touch events are updated in a multitouch environment
 */
#define GR_EVENT_MT_START "gre.mtstart"
...
/**
 * Event that is fired when all multi touch events have been updated
 */
#define GR_EVENT_MT_STOP "gre.mtstop"
...
#define GR_EVENT_ANIMATION_COMPLETE_FMT	NULL
